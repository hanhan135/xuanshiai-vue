...
expect(api, 'return getServiceMatchmakers()', 'released parent service lists use the real API without a Mock switch')
expect(api, 'return getCustomMatchmakers()', 'released parent custom lists use the real API without a Mock switch')
